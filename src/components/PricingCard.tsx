      ...
      <div className="max-w-xl mx-auto">
        <div
          ...
          style={{
            ...
            boxShadow: "0 0 80px rgba(248, 114, 21, 0.18)",
          }}
        >
          <p
          ...
          <p className="text-sm md:text-base" style={{ color: "#D4CFC4" }}>
            Two <strong className="text-white">LIVE</strong> bootcamps with
            Swastik, every month
          </p>
          ...
          <p className="text-sm mb-6" style={{ color: MUTED }}>
            GST included. Not plus GST — <em>included</em>. Locked for life
            while you stay.
          </p>
  ...
  Click here to join Super Founders now
          ...
          <div className="mt-8 text-left">
            ...
            <p className="text-xs mt-4 leading-relaxed" style={{ color: MUTED }}>
              The price steps up with every 100 members — and steps up again at
              200. Whatever price you lock today is yours for as long as you
              stay. No countdown clock — just seats filling.
            </p>
          </div>
